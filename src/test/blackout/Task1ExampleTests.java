...
public class Task1ExampleTests {
    ...
    @Test
    public void basicFileSupportWithDifferentDevice() {
        // Task 1
        BlackoutController controller = new BlackoutController();
        ...
        assertEquals(new EntityInfoResponse("DeviceA", Angle.fromDegrees(180), RADIUS_OF_JUPITER, "HandheldDevice"),
                controller.getInfo("DeviceA"));
        ...
        expected.put("Hello World",
                new FileInfoResponse("Hello World", "My first file!", "My first file!".length(), true));
        assertEquals(new EntityInfoResponse("DeviceA", Angle.fromDegrees(180), RADIUS_OF_JUPITER, "HandheldDevice",
                expected), controller.getInfo("DeviceA"));
    }

    @Test
    public void testCompleteWithDeletion() {
        // Task 1
        // Example from the specification
        BlackoutController controller = new BlackoutController();
